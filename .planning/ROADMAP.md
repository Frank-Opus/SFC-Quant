...
Plans:
- [ ] 03-01: Define PrimoAgent role graph and typed decision contracts
- [ ] 03-02: Implement provider adapter boundary for third-party AI vendors
- [ ] 03-03: Add orchestration services for manual and scheduled analysis runs
- [ ] 03-04: Persist and expose per-agent rationale/status payloads
...
Plans:
- [ ] 05-01: Implement risk-policy schemas and server-side enforcement
- [ ] 05-02: Add trade-approval workflow between agents and execution
- [ ] 05-03: Add global halt / kill-switch behavior for breached limits
- [ ] 05-04: Add guarded live-mode enablement flow and audit events
...
|-------|----------------|--------|-----------|
| 1. Foundation & Local Runtime | 0/4 | Not started | - |
