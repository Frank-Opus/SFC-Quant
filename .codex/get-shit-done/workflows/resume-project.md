...
<required_reading>
@/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)
