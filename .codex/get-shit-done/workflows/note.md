...
- **Global scope**: `/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/notes/`)
...
2. Glob `/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/wanguancheng/.AAAAAA/ai-quant-empire/.codex/notes/` — works in any directory
